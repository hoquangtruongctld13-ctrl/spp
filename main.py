...
# Cấu hình giao diện CustomTkinter - Modern Studio Theme
...
class StudioGUI(ctk.CTk):
    ...
    def __init__(self):
        ...
        # Window Setup - Modern Professional Studio
        self.title("Professional TTS Studio")
        
        # Professional window sizing and positioning
        window_width = 1600
        window_height = 950
    ...
    def _setup_ui(self):
        # Modern Main Container with clean layout
        self.tabview = ctk.CTkTabview(self, width=1580, height=930)
        self.tabview.pack(fill="both", expand=True, padx=15, pady=15)

        # Create Simplified Tabs - Professional Studio Layout
        self.tab_dashboard = self.tabview.add("Gemini TTS")
        self.tab_longtext = self.tabview.add("Long Text")
        self.tab_capcut = self.tabview.add("Capcut")
        self.tab_edge = self.tabview.add("Edge TTS")
        self.tab_vieneu = self.tabview.add("VN TTS")
        self.tab_settings = self.tabview.add("Settings")

        # Setup Content with Modern Design
    ...
    def _setup_settings_tab(self):
        ...
        google_frame = ctk.CTkFrame(tab, fg_color="#1e2a3a", corner_radius=12)
        google_frame.grid(row=0, column=0, sticky="nsew", padx=8, pady=12)
        
        # Modern Header
        header_google = ctk.CTkFrame(google_frame, fg_color="#2d5f8d", height=45, corner_radius=10)
        header_google.pack(fill="x", padx=8, pady=8)
        ctk.CTkLabel(header_google, text="GOOGLE GEMINI TTS", font=("Roboto", 13, "bold"), text_color="white").pack(pady=10)
        ...
        # --- Column 2: CAPCUT VOICE SETTINGS ---
        capcut_frame = ctk.CTkFrame(tab, fg_color="#1e2a3a", corner_radius=12)
        capcut_frame.grid(row=0, column=1, sticky="nsew", padx=8, pady=12)
        
        header_capcut = ctk.CTkFrame(capcut_frame, fg_color="#8d4a2d", height=45, corner_radius=10)
        header_capcut.pack(fill="x", padx=8, pady=8)
        ctk.CTkLabel(header_capcut, text="CAPCUT VOICE", font=("Roboto", 13, "bold"), text_color="white").pack(pady=10)
        ...
        btn_add_voice = ctk.CTkButton(add_voice_frame, text="Add Voice", width=80, 
                                     fg_color="#4a7c59", hover_color="#3d6b4a",
                                     corner_radius=8, command=self._add_custom_capcut_voice)
        ...
        # --- Column 3: EDGE TTS CONFIG ---
        edge_frame = ctk.CTkFrame(tab, fg_color="#1e2a3a", corner_radius=12)
        edge_frame.grid(row=0, column=2, sticky="nsew", padx=8, pady=12)
        
        # Modern Header
        header_edge = ctk.CTkFrame(edge_frame, fg_color="#5a4a8d", height=45, corner_radius=10)
        header_edge.pack(fill="x", padx=8, pady=8)
        ctk.CTkLabel(header_edge, text="EDGE TTS & FFMPEG", font=("Roboto", 13, "bold"), text_color="white").pack(pady=10)
        ...
        btn_refresh_edge = ctk.CTkButton(edge_frame, text="Refresh Voice List", 
                                        fg_color="#5a6a8d", hover_color="#4a5a7d",
                                        corner_radius=8, command=self._refresh_edge_voices)
    ...
    def _setup_multivoice_tab(self):
        ...
        ctk.CTkLabel(settings_frame, text="Voice Settings", font=("Roboto", 14, "bold")).pack(anchor="w", padx=15, pady=(15, 10))
